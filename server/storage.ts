...
Think of your home's cleanliness in layers. Regular upkeep manages the surface layer, preserving daily order. Periodic professional deep cleaning resets the foundational layer, stripping away the embedded grime and allergens that accumulate inevitably in Dubai's setting. It's an investment in the core hygiene and freshness of your living environment.`,
    ...
    const products: Product[] = [
      {
        id: randomUUID(),
        name: "Artisan Geometric Wallpaper",
        description: "Hand-printed geometric wallpaper in metallic gold on matte cream. Made with eco-friendly water-based inks, each roll covers approximately 5.5 square meters.",
        price: 2500,
        category: "Wallpapers",
        ...
        materials: "Non-woven fabric, water-based eco inks",
        dimensions: "53cm x 10m per roll",
        colors: ["Gold & Cream", "Silver & Grey", "Navy & White"],
        sku: "WP-GEO-001",
        inStock: true,
        featured: true,
        discount: 27,
      },
      {
        ...
        description: "Contemporary L-shaped sectional featuring deep cushioning, solid kiln-dried hardwood frame, and stain-resistant Italian linen upholstery. Includes adjustable headrests and hidden storage.",
        price: 15000,
        category: "Sofas",
        ...
        materials: "Kiln-dried hardwood frame, Italian linen, HR foam",
        dimensions: "280cm x 180cm x 85cm (H)",
        colors: ["Ivory", "Charcoal", "Sage Green", "Navy"],
        sku: "SF-MIL-001",
        inStock: true,
        featured: true,
        discount: 15,
      ...
      {
        id: randomUUID(),
        name: "Vienna 3-Seater Velvet Sofa",
        description: "Luxurious 3-seater sofa upholstered in premium velvet with gold-finished metal legs. Features pocket spring seating and removable cushion covers.",
        price: 9800,
        category: "Sofas",
        ...
        materials: "Premium velvet, brass-finished steel legs, pocket springs",
        dimensions: "220cm x 90cm x 82cm (H)",
        colors: ["Emerald Green", "Royal Blue", "Dusty Rose"],
        sku: "SF-VIE-001",
        inStock: true,
        featured: false,
        discount: 20,
      },
      {
        ...
        description: "Custom-crafted king-size platform bed with a tufted wingback headboard in premium bouclé fabric. Includes integrated under-bed storage drawers and reinforced slat base.",
        price: 14500,
        category: "Beds",
        ...
        materials: "Solid oak frame, bouclé fabric headboard, plywood slats",
        dimensions: "210cm x 190cm x 120cm (H) — King",
        colors: ["Cream Bouclé", "Grey Linen", "Walnut Wood"],
        sku: "BD-RYL-001",
        inStock: true,
        featured: true,
        discount: 10,
      ...
      {
        id: randomUUID(),
        name: "Nordic Queen Bed with Storage",
        description: "Scandinavian-inspired queen bed with hydraulic lift storage and a clean-lined upholstered headboard. Solid pine frame with natural finish.",
        price: 8900,
        category: "Beds",
        ...
        materials: "Solid pine, cotton-linen blend upholstery",
        dimensions: "200cm x 160cm x 95cm (H) — Queen",
        colors: ["Natural Pine", "White Oak", "Dark Walnut"],
        sku: "BD-NRD-001",
        inStock: true,
        featured: false,
        discount: 18,
      },
      {
        ...
        description: "Handcrafted coffee table featuring a genuine Carrara marble top on a brushed brass geometric base. Each piece is unique due to natural marble veining.",
        price: 4800,
        ...
        images: [
          ...
          "https://images.unsplash.com/photo-1619596662481-7e8d7173d9f3?w=800&q=80",
          "https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?w=800&q=80"
        ],
        materials: "Carrara marble top, brushed brass steel base",
        dimensions: "120cm x 60cm x 42cm (H)",
        colors: ["White Marble / Brass", "Black Marble / Chrome"],
        sku: "CT-CAR-001",
        inStock: true,
        featured: true,
        discount: 0,
      ...
      {
        id: randomUUID(),
        name: "Walnut Live Edge Coffee Table",
        description: "One-of-a-kind live edge coffee table crafted from a single slab of American black walnut. Finished with food-safe natural oil and paired with matte black steel legs.",
        price: 6200,
        category: "Coffee Tables",
        ...
        materials: "American black walnut slab, matte black steel legs",
        dimensions: "140cm x 65cm x 40cm (H)",
      ...
      {
        id: randomUUID(),
        name: "Terracotta Round Side Table",
        description: "Minimalist round side table with a terracotta-finished concrete top and solid ash wood legs. Perfect as a bedside or accent table.",
        price: 1800,
        category: "Side Tables",
        image: "https://images.unsplash.com/photo-1616046386908-a13cc9058d29?w=800&q=80",
        images: [
          "https://images.unsplash.com/photo-1616046386908-a13cc9058d29?w=800&q=80",
          "https://images.unsplash.com/photo-1595428773881-b2b9f7c9388d?w=800&q=80"
        ],
        materials: "Polished concrete, solid ash wood",
        dimensions: "45cm (D) x 55cm (H)",
        colors: ["Terracotta", "Natural Grey", "Sand"],
        sku: "ST-TER-001",
        inStock: true,
        featured: false,
        discount: 10,
      ...
      {
        id: randomUUID(),
        name: "Brass & Glass Nesting Tables",
        description: "Set of two nesting tables with tempered glass tops and polished brass frames. Elegant design that saves space when nested together.",
        price: 3200,
        category: "Side Tables",
        ...
        materials: "Tempered glass, polished brass frame",
        dimensions: "Large: 50cm x 55cm (H), Small: 40cm x 45cm (H)",
        colors: ["Brass & Clear Glass", "Chrome & Smoked Glass"],
        sku: "ST-NST-001",
        inStock: true,
        featured: true,
        discount: 15,
      ...
      {
        id: randomUUID(),
        name: "Minimal Wall Clock — Noir",
        description: "Ultra-thin wall clock with a matte black aluminium face and silent sweep movement. Designed for minimal interiors with easy wall mounting.",
        price: 950,
        category: "Clocks",
        ...
        materials: "Anodized aluminium, quartz movement",
        dimensions: "40cm diameter x 3cm depth",
        colors: ["Matte Black", "Brushed Gold", "Silver"],
        sku: "CL-NOR-001",
        inStock: true,
        featured: false,
        discount: 0,
      ...
      {
        id: randomUUID(),
        name: "Professional Gas Hob — 5 Burner",
        description: "Commercial-grade 5-burner gas hob with cast iron pan supports, auto-ignition, and flame failure safety device. Stainless steel surface for easy cleaning.",
        price: 4500,
        category: "Kitchen",
        ...
        materials: "Stainless steel body, cast iron pan supports, brass burners",
        dimensions: "90cm x 52cm x 5cm (H)",
      ...
      {
        id: randomUUID(),
        name: "Island Chimney Hood — 90cm",
        description: "High-performance island chimney hood with baffle filters, LED lighting, touch controls, and powerful 1200 m³/h extraction. Auto-clean technology for hassle-free maintenance.",
        price: 8500,
        category: "Kitchen",
        ...
        materials: "Stainless steel, tempered glass panel",
        dimensions: "90cm x 60cm x adjustable height",
      ...
      },
      {
        ...
        description: "Ergonomic dining chair inspired by mid-century Danish design. Solid beech wood legs with a curved plywood shell upholstered in premium wool felt.",
        price: 1800,
        category: "Chairs",
        ...
        materials: "Solid beech wood, curved plywood, wool felt upholstery",
        dimensions: "52cm x 56cm x 82cm (H), Seat: 46cm",
        colors: ["Natural / Grey Felt", "Walnut / Charcoal", "White / Teal"],
        sku: "CH-SCA-001",
        inStock: true,
        featured: false,
        discount: 0,
      ...
      {
        id: randomUUID(),
        name: "Velvet Accent Chair — Wingback",
        description: "Statement wingback accent chair with deep button tufting. Solid oak legs with antique brass caps. Perfect for reading corners and living rooms.",
        price: 3400,
        category: "Chairs",
        ...
        materials: "Premium velvet, solid oak legs, brass caps",
        dimensions: "75cm x 80cm x 105cm (H)",
        colors: ["Emerald Velvet", "Navy Velvet", "Blush Pink"],
        sku: "CH-WNG-001",
        inStock: true,
        featured: true,
        discount: 10,
      },
      {
        ...
        description: "Compact bedside table crafted from solid European oak with a soft-close drawer and open shelf. Oil-finished for a natural, tactile feel.",
        price: 1500,
        ...
        materials: "Solid European oak, steel drawer runners",
        dimensions: "45cm x 40cm x 55cm (H)",
        colors: ["Natural Oak", "Dark Stain", "White Wash"],
        sku: "BT-OAK-001",
        inStock: true,
        featured: false,
        discount: 0,
      },
      {
        ...
        description: "Hand-woven rattan pendant light creating warm, dappled light patterns. Natural finish with adjustable cord length. Ideal for dining areas and bedrooms.",
        price: 1200,
        category: "Lighting",
        image: "https://images.unsplash.com/photo-1507473885765-e6ed057ab3fe?w=800&q=80",
        images: [
          "https://images.unsplash.com/photo-1507473885765-e6ed057ab3fe?w=800&q=80",
          "https://images.unsplash.com/photo-1540932239986-30128078f3c5?w=800&q=80"
        ],
        materials: "Natural rattan, fabric-wrapped cord, metal ceiling plate",
        dimensions: "50cm diameter x 40cm (H), adjustable drop to 150cm",
      ...
      },
      {
        ...
        description: "Dramatic arc floor lamp with a brushed brass finish and a natural linen drum shade. Weighted marble base for stability. Dimmable with rotary switch.",
        price: 3800,
        category: "Lighting",
        ...
        materials: "Brushed brass, white marble base, linen shade",
        dimensions: "Base: 35cm, Height: 195cm, Shade: 45cm (D)",
        colors: ["Brass / White Marble", "Matte Black / Black Marble"],
        sku: "LT-ARC-001",
        inStock: true,
        featured: false,
        discount: 12,
      ...
      {
        id: randomUUID(),
        name: "Woven Textured Cushion Set",
        description: "Set of 3 handwoven cushions with varied textures — bouclé, linen, and chunky knit. Removable covers with hidden zips. Hypoallergenic poly-fill inserts included.",
        price: 680,
        category: "Decor",
        ...
        materials: "Bouclé, linen, chunky cotton knit, poly-fill inserts",
        dimensions: "50cm x 50cm each",
        colors: ["Ivory & Sand Set", "Grey & Charcoal Set", "Rust & Terracotta Set"],
        sku: "DC-CSH-001",
        inStock: true,
        featured: false,
        discount: 0,
      },
      {
        ...
        description: "Set of 3 artisan ceramic vases in complementary organic forms. Each piece is wheel-thrown and hand-glazed, making every set unique.",
        price: 1100,
        category: "Decor",
        ...
        materials: "Stoneware ceramic, hand-applied glaze",
        dimensions: "Small: 15cm (H), Medium: 22cm (H), Large: 30cm (H)",
        colors: ["White & Speckle", "Sage Green", "Midnight Blue"],
        sku: "DC-VAS-001",
        inStock: true,
        featured: true,
        discount: 0,
      },
      {
        ...
        description: "Statement 8-seater dining table crafted from sustainably sourced solid European oak. Angled trapezoid legs and a smooth oil-finished top.",
        price: 11500,
        category: "Dining",
        image: "https://images.unsplash.com/photo-1617806118233-18e1de247200?w=800&q=80",
        images: [
          "https://images.unsplash.com/photo-1617806118233-18e1de247200?w=800&q=80",
          "https://images.unsplash.com/photo-1595514535116-d3e0baedffc0?w=800&q=80"
        ],
        materials: "Solid European oak, natural oil finish",
        dimensions: "220cm x 100cm x 76cm (H)",
      ...
      {
        id: randomUUID(),
        name: "Moroccan Handwoven Area Rug",
        description: "Authentic handwoven Moroccan Beni Ourain-style area rug in plush 100% New Zealand wool. Soft, dense pile with geometric diamond patterns.",
        price: 5200,
        category: "Decor",
        ...
        materials: "100% New Zealand wool, cotton warp",
        dimensions: "250cm x 350cm",
        colors: ["Ivory / Black Diamond", "Grey / White", "Rust / Cream"],
        sku: "DC-RUG-001",
        inStock: true,
        featured: false,
        discount: 15,
      ...
      {
        id: randomUUID(),
        name: "Modular TV Entertainment Unit",
        description: "Sleek wall-mounted entertainment unit with cable management, push-to-open doors, and ambient LED backlighting. Customizable module configuration.",
        price: 7200,
        category: "Storage",
        ...
        materials: "Engineered wood with walnut veneer, matte lacquer doors",
        dimensions: "240cm x 45cm x 50cm (H), wall-mounted",
        colors: ["Walnut / White", "Oak / Grey", "All White"],
        sku: "ST-TVU-001",
        inStock: true,
        featured: false,
        discount: 5,
      ...
      {
        id: randomUUID(),
        name: "Custom Walk-in Wardrobe System",
        description: "Fully customizable walk-in wardrobe system with hanging rails, shelving, drawers, and shoe racks. Soft-close hardware throughout. Professional installation included.",
        price: 18500,
        category: "Storage",
        ...
        materials: "MDF with melamine finish, soft-close hinges, steel rails",
        dimensions: "Custom — fits rooms from 4 sqm to 20 sqm",
        colors: ["White Gloss", "Linen Texture", "Dark Oak"],
        sku: "ST-WDR-001",
        inStock: true,
        featured: true,
        discount: 0,
      ...
      {
        id: randomUUID(),
        name: "Botanical Print Wallpaper",
        description: "Luxurious botanical print wallpaper featuring oversized tropical foliage on a deep green background. Easy paste-the-wall application.",
        price: 3200,
        category: "Wallpapers",
        ...
        materials: "Non-woven paper, paste-the-wall application",
        dimensions: "53cm x 10m per roll",
        colors: ["Deep Green", "Blush Pink", "Navy"],
        sku: "WP-BOT-001",
        inStock: true,
        featured: false,
        discount: 20,
