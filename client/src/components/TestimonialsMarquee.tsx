  ...
  return (
    <section className="py-24 bg-gradient-to-b from-background to-muted/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-16">
        ...
        >
          <p className="text-sm uppercase tracking-wider text-[#D7A144] font-semibold mb-4">
            ...
            >
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#D7A144] to-[#C69136] flex items-center justify-center text-white font-bold text-lg">
