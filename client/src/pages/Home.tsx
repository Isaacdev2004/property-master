  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        {/* Statistics Pill - Positioned at bottom of hero, half overlapping */}
        <motion.div 
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.8, ease: [0.25, 0.46, 0.45, 0.94] }}
          className="absolute -bottom-10 left-1/2 -translate-x-1/2 z-20 w-[95%] max-w-3xl"
        >
          <div 
            className="bg-white rounded-full shadow-2xl py-4 px-3 sm:px-6 flex items-center justify-between"
            data-testid="stats-pill"
          >
            {/* Stat 1: Projects */}
            <div className="flex items-center gap-1 sm:gap-2 flex-1 justify-center">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#D7A144] flex-shrink-0 hidden sm:block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
              <div className="text-center">
                <p className="text-sm sm:text-lg font-bold text-[#D7A144] leading-tight">5000+</p>
                <p className="text-[8px] sm:text-[10px] text-gray-500 uppercase tracking-wide leading-tight whitespace-nowrap">Projects Completed</p>
              </div>
            </div>
            
            <div className="w-px h-10 bg-[#D7A144]/30 flex-shrink-0"></div>
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-1 justify-center">
              ...
              <div className="text-center">
                <p className="text-sm sm:text-lg font-bold text-[#D7A144] leading-tight">200+</p>
                <p className="text-[8px] sm:text-[10px] text-gray-500 uppercase tracking-wide leading-tight whitespace-nowrap">Property Experts</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-1 justify-center">
              ...
              <div className="text-center">
                <p className="text-sm sm:text-lg font-bold text-[#D7A144] leading-tight">10 Cities</p>
                <p className="text-[8px] sm:text-[10px] text-gray-500 uppercase tracking-wide leading-tight whitespace-nowrap">2 Countries</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-1 justify-center">
              ...
              <div className="text-center">
                <p className="text-sm sm:text-lg font-bold text-[#D7A144] leading-tight">3 Services</p>
                <p className="text-[8px] sm:text-[10px] text-gray-500 uppercase tracking-wide leading-tight whitespace-nowrap">All Property Needs</p>
              </div>
            </div>
          </div>
        </motion.div>
