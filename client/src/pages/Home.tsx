        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 px-2">
              <svg className="w-5 h-5 text-[#D7A144] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
              <div>
                <p className="text-lg font-bold text-[#D7A144] leading-tight">5000+</p>
                <p className="text-[10px] text-gray-500 uppercase tracking-wide">Projects Completed</p>
              </div>
            </div>
            
            <div className="w-px h-10 bg-[#D7A144]/30"></div>
            ...
            <div className="flex items-center gap-2 px-2">
              ...
              <div>
                <p className="text-lg font-bold text-[#D7A144] leading-tight">200+</p>
            ...
            <div className="flex items-center gap-2 px-2">
              ...
              <div>
                <p className="text-lg font-bold text-[#D7A144] leading-tight">10 Cities</p>
            ...
            <div className="flex items-center gap-2 px-2">
              ...
              <div>
                <p className="text-lg font-bold text-[#D7A144] leading-tight">3 Services</p>
