  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        {/* Statistics Pill - Positioned at bottom of hero */}
        <motion.div 
        ...
        >
          <div 
            className="bg-white/95 backdrop-blur-sm rounded-full shadow-xl py-3 px-4 md:px-6 flex items-center justify-center gap-2 md:gap-4"
            data-testid="stats-pill"
          >
            <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3">
              <svg className="w-4 h-4 md:w-5 md:h-5 text-[#D7A144] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
              </svg>
              <div className="text-center">
                <p className="text-base md:text-lg font-bold text-[#D7A144] leading-tight">5000+</p>
                <p className="text-[9px] md:text-[10px] text-gray-500 uppercase tracking-wide leading-tight">Projects Completed</p>
              </div>
            </div>
            
            <div className="w-px h-8 bg-[#D7A144]/30 flex-shrink-0"></div>
            ...
            <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3">
              ...
              <div className="text-center">
                <p className="text-base md:text-lg font-bold text-[#D7A144] leading-tight">200+</p>
                <p className="text-[9px] md:text-[10px] text-gray-500 uppercase tracking-wide leading-tight">Property Experts</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3">
              ...
              <div className="text-center">
                <p className="text-base md:text-lg font-bold text-[#D7A144] leading-tight">10 Cities</p>
                <p className="text-[9px] md:text-[10px] text-gray-500 uppercase tracking-wide leading-tight">2 Countries</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3">
              ...
              <div className="text-center">
                <p className="text-base md:text-lg font-bold text-[#D7A144] leading-tight">3 Services</p>
                <p className="text-[9px] md:text-[10px] text-gray-500 uppercase tracking-wide leading-tight">All Property Needs</p>
              </div>
            </div>
          </div>
        </motion.div>
