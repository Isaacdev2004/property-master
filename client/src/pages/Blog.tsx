    ...
    <div className="min-h-screen pt-20">
      <section className="py-24 bg-gradient-to-b from-primary/10 to-background">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6 font-[Archivo]">Design & Lifestyle Blog</h1>
      ...
      {featuredPosts.length > 0 && (
        <section className="py-12 bg-background">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <motion.div {...fadeInUp}>
              <h2 className="text-2xl font-bold mb-6 font-[Archivo]">Featured Articles</h2>
                    ...
                    <Card className="group hover-elevate transition-all duration-300 overflow-hidden cursor-pointer">
                      <CardContent className="p-0">
                        ...
                        <div className="p-6">
                          ...
                          <h3 className="text-2xl font-bold mb-3 font-[Archivo] line-clamp-2 group-hover:text-primary transition-colors">
                            {post.title}
                          </h3>
                    ...
                    <Card className="group h-full hover-elevate transition-all duration-300 overflow-hidden cursor-pointer">
                      <CardContent className="p-0">
                        ...
                        <div className="p-6">
                          ...
                          <h3 className="text-xl font-bold mb-3 font-[Archivo] line-clamp-2 group-hover:text-primary transition-colors">
                            {post.title}
                          </h3>
